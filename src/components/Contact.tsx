        ...
        <div className="flex flex-wrap -m-2">
          ...
          <div className="p-2 w-full">
            <div className="relative">
              ...
              <textarea id="message" name="message" className="w-full bg-white bg-opacity-50 rounded border border-white focus:border-white focus:bg-white focus:ring-2 focus:ring-white h-32 text-base outline-none text-white py-1 px-3 resize-none leading-6 transition-colors duration-200 ease-in-out"></textarea>
            </div>
          </div>
          <div className="p-2 w-full">
